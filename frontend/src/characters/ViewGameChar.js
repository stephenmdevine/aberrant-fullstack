                    ...
                    <Container className='my-4'>
                        ...
                        <Row>
                            <Col sm={4}>
                                ...
                                <h3 style={{ textAlignLast: 'justify', textAlign: 'justify' }}><SymbolDisplay value={gameChar.quantumBonus + gameChar.quantumNova + 1} max={10} /></h3>
                            </Col>
                            <Col sm={4}>
                                <h3>Mega-Attributes</h3>
                                <ListGroup>
                                    {megaAttributes.map((megaAttribute, index) => (
                                        <div>
                                                ...
                                                <ListGroup.Item key={index}>
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-6 text-start">
                                                            <SymbolDisplay value={megaAttribute.value + megaAttribute.expValue} />
                                                        </div>
                                                    </div>
                                                    <div>
